...
const ProjectsTable = () => {
    ...
    return (
        <div className="overflow-x-hidden w-auto! flex-1 bg-linear-to-r from-secondary to-tertiary rounded-3xl p-6 flex flex-col justify-between items-start *:w-full">
            <h4 className="text-white text-xl font-ubuntuBold capitalize">
                {title}
            </h4>
            <div className="overflow-x-auto">
                <table className="w-200! lg:w-full! divide-y divide-slate-700 mt-9">
                    <thead>
