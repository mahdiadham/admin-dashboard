...
const Projects = () => {
    ...
    return (
        <div className="w-auto! overflow-x-hidden sm:flex-1/2 bg-linear-to-r from-secondary to-tertiary rounded-3xl h-128 p-6 flex flex-col justify-between items-start *:w-full">
            ...
            <div className="overflow-x-auto">
                <table className="w-200! lg:w-full!">
                    <thead>
