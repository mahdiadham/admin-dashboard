...
const Header = ({ isOpen, setIsOpen }) => {
    ...
    return (
        <header className="w-full sticky top-5 flex justify-center items-center z-12!">
            ...
            >
                ...
                <div className="flex justify-between items-center gap-x-4">
                    <div className="sm:w-60 sm:bg-white/5 rounded-full sm:rounded-2xl flex justify-between items-center gap-2 sm:p-2 sm:border border-slate-600">
                        <IoIosSearch className="sm:text-white/60 sm:size-6 size-5 text-white max-sm:cursor-pointer" />
                        <input type="text" placeholder="Type here ..." className="max-sm:hidden w-full bg-transparent text-white focus:outline-none" />
                    </div>
